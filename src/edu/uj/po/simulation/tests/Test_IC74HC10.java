...
public class Test_IC74HC10 extends TestBase {
    ...
    protected void testComponent() {
        ...
        test_all_gates_should_return_low_beucase_of_majority_has_two_trues_because_of_mixed_states();
        test_all_gates_should_return_low_beucase_of_majority_has_two_false_because_of_mixed_states();
    }
    /**
     ...
     */
    private void test_all_gates_should_return_low_beucase_of_majority_has_two_trues_because_of_mixed_states() {
        resetPins(this.component);
        PinState targetState = PinState.HIGH;
     ...
     */
    private void test_all_gates_should_return_low_beucase_of_majority_has_two_false_because_of_mixed_states() {
        resetPins(this.component);
        PinState targetState = PinState.HIGH;
