...
public class Test_IC74HC08 extends TestBase {
    private final IC74HC08 component;

    public Test_IC74HC08() throws UnknownChip {
        super();
        this.component = (IC74HC08) this.director.orderComponentBuild(7408);
    }
