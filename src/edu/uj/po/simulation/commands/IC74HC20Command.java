...
public class IC74HC20Command implements ComponentCommand {
    ...
    private static PinState nandFunc(PinState pin1, PinState pin2, PinState pin3, PinState pin4) {
        if (pin1 == PinState.HIGH && pin2 == PinState.HIGH && pin3 == PinState.HIGH && pin4 == PinState.HIGH) {
            return PinState.LOW; 
        } else if (pin1 == PinState.UNKNOWN || pin2 == PinState.UNKNOWN || pin3 == PinState.UNKNOWN || pin4 == PinState.UNKNOWN) {
